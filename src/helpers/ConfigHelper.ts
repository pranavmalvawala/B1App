...
export interface ConfigurationInterface { keyName?: string, churchId?: string, primaryColor?: string, primaryContrast?: string, secondaryColor?: string, secondaryContrast?: string, logoSquare?: string, logoHeader?: string, buttons?: ButtonInterface[], tabs?: LinkInterface[], services?: ServiceInterface[], switchToConversationId: string, jitsiRoom: string }
